...
import com.koifolio.FolioApplication
import com.koifolio.injection.component.ConfigPersistentComponent
import com.koifolio.injection.component.DaggerConfigPersistentComponent
import com.koifolio.injection.component.FragmentComponent
import com.koifolio.injection.module.FragmentModule
import com.shivamdev.phonepaynotes.di.component.FragmentComponent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (componentsArray.get(fragmentId) == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .appComponent(FolioApplication[activity as Context].component)
                    .build()
